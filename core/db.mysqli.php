...
class database extends dcom
{
	public function __construct($d = false)
	{
		...
		ob_start();
		$this->connect = @mysqli_connect($this->_access['server'], $this->_access['login'], $this->_access['secret'], false, MYSQL_CLIENT_COMPRESS);
		ob_end_clean();
		...
		if (!@mysqli_select_db($this->_access['database']))
		{
			exit('331');
		}
		unset($this->_access);
